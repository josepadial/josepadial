...
<p align="center">
  Cloud Software Architect • PhD in AI • Building platforms with security, compliance, and developer experience in mind.
</p>
...
**Cloud & Platform**  
Kubernetes • Helm • Docker • Terraform • GitHub Actions • Argo CD • Vault • OPA/Gatekeeper

**CI/CD & Supply Chain**  
Jenkins (controllers & agents at scale) • Tekton • SBOMs • SLSA-style controls • Sigstore/Cosign

**Languages**  
Python • Java • TypeScript • Bash

**Observability & SRE**  
OpenTelemetry • Prometheus • Grafana • Loki • Tracing • Error budgets • Incident response
